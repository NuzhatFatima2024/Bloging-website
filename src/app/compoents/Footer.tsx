    ...
    <footer className="bg-gradient-to-r from-gray-900 via-gray-700 to-black py-8 px-4 text-center">
      <div className="mx-auto flex flex-col items-center justify-center">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mb-6">
          <Link href="https://github.com/NuzhatFatima2024" aria-label="GitHub Profile"
            target="_blank"
          ...
          <Link href="mailto:nf5481845@gmail.com"
            aria-label="Email"
            className="transition-transform transform hover:scale-110 hover:text-gray-400 text-gray-200 p-3 rounded-full text-4xl"
          >
            <FaEnvelope />
          ...
          <Link href="https://www.linkedin.com/in/anam-noman-83500991"
        ...
        <p className="text-sm text-gray-400 mt-6">
          &copy; {new Date().getFullYear()} Nuzhat Fatima | All Rights Reserved
        </p>
      </div>
    </footer>
  );
